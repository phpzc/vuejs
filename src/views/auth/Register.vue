...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            register(e) {
                //提交表单后 实例的 $nextTick 方法用于在下次 DOM 更新循环结束之后执行延迟回调。在我们的代码里，当我们点击注册按钮后，表单验证指令有为按钮添加一个 canSubmit 的属性，但 DOM 没有立即更新，所以我们需在 $nextTick 的延迟回调里，获取更新后的元素属性，此时的 canSubmit 才是正确的值。
                this.$nextTick(
                    () => {
